...
fn test_shp_to_txt_one_to_one() {
    ...
    let options = convert::ShpToTxtOptions {
        ...
        output_mode: "one_to_one".into(), filename_field: String::new(), og: false, zone_type: 3, proj_no_prefix: false, plot_filter: None, bubeian: None,
    };
...
fn test_shp_to_txt_merge_all() {
    ...
    let options = convert::ShpToTxtOptions {
        ...
        proj_zone: None,
        ox: false, oj: true, on: false, oo: true, oc: false,
        output_mode: "merge_all".into(), filename_field: String::new(), og: false, zone_type: 3, proj_no_prefix: false, plot_filter: None, bubeian: None,
    };
...
fn test_shp_to_txt_split_by_plot() {
    ...
    let options = convert::ShpToTxtOptions {
        ...
        proj_zone: None,
        ox: false, oj: true, on: false, oo: true, oc: false,
        output_mode: "split_by_plot".into(), filename_field: String::new(), og: false, zone_type: 3, proj_no_prefix: false, plot_filter: None, bubeian: None,
    };
...
fn test_shp_to_txt_full() {
    ...
    let options = convert::ShpToTxtOptions {
        ...
        filename_field: String::new(), og: false, zone_type: 3, proj_no_prefix: false, plot_filter: None, bubeian: None,
    };
